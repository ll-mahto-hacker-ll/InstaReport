...
${Fore.GREEN}============================== HELP  ==============================
    ...
    if (int(que_ans)==1):
        ...
        To buy proxies go to https://t.me/Zhangweii and ask proxy.
        ...
        For more help you can directly contact me on https://t.me/Zhangweii
        Or you can report bugs at https://t.me/Zhangweii
        ...
        ''')
        help_msg()
        webbrowser.open('https://t.me/Zhangweii')
    elif(int(que_ans)==4):
        clearConsole()
